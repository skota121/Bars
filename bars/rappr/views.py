...
def detail(request, music):
	nltk.data.path.append("/Users/skota121/anaconda/lib/python2.7/site-packages/nltk")
...
def results(request, rapper_name):
	response = "Here's %s."
	return HttpResponse(response % rapper_name)
